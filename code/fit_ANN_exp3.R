...
test_ANN <- test
valid_ANN <- valid
save(train_ANN, file = paste("data/exp3_data/train_data_exp3_ANN",".RData",sep=""))
save(test_ANN, file = paste("data/exp3_data/test_data_exp3_ANN",".RData",sep=""))
save(valid_ANN, file = paste("data/exp3_data/valid_data_exp3_ANN",".RData",sep=""))

# We also need to save m and M for de-normalization later. 
normalization_constants <- data.frame("m" = m, "M" = M)
write.csv(normalization_constants,"data/exp3_data/normalization_constants_exp3.csv", row.names = F)
